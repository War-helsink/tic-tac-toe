		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					className={cn(
						"group/sidebar-wrapper flex h-[calc(100svh-8rem)] w-full relative has-data-[variant=inset]:bg-sidebar",
						className,
					)}
					{...props}
				>
...
> = ({
	...
	return (
		<div
			ref={ref}
			className="group peer hidden h-full md:block text-sidebar-foreground"
			data-state={state}
...
const SidebarMenuBadge: React.FC<
	React.ComponentProps<"div"> & {
		ref?: React.RefObject<HTMLDivElement>;
	}
> = ({ className, ...props }) => (
...
const SidebarMenuSubItem: React.FC<
	React.ComponentProps<"li"> & {
		ref?: React.RefObject<HTMLLIElement>;
	}
> = ({ ...props }) => <li {...props} />;
