...
export const AvatarPartColorItem: React.FC<AvatarPartColorItemProps> = ({
	...
	return (
		<button
			...
			type="button"
			className={cn(
				"min-w-12 w-12 min-h-12 h-12 flex items-center justify-center rounded-full border transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95",
				isActive
